...
public class UsersResources {
	...
	// PUT PASSWORD USER
		...
		public Response changePassword(@PathParam("username") String username, @FormParam("pass") String pass,
			...
			try {
				...
				// Get user data
				String Autoruser = (String) Jwts.parser().setSigningKey(userManager.getKey()).parseClaimsJws(token)
						.getBody().get("username");

				userManager.MudaPassword(username, pass, NovaPassword, Autoruser);
